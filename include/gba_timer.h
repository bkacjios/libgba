 ...
 */
extern void gba_timer_init(u_char timer, u_short conf, u_short val);
 ...
 * @param timer Number of timer
 */
extern void gba_timer_start(u_char timer);
 ...
 * @param timer Number of timer
 */
extern void gba_timer_stop(u_char timer);
 ...
 * @param timer Number of timer
 */
extern u_short gba_timer_get_counter(u_char timer);
 ...
 */
extern void gba_timer_reload(u_char timer, u_short val);
