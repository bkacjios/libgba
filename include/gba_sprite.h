 ...
 */
extern void gba_oam_update(void);
 ...
 */
extern void gba_sprite_disable();
 ...
 */
extern void gba_sprite_init_palette256(const void * palette);
 ...
 * @param palette The palette
 */
extern void gba_sprite_init_palette16(short index, const void * palette);
 ...
 */
extern void gba_sprite_new(sprite_struct * sp, short size, short color, const void *data, int len);
 ...
 * @param sp Pointer to sprite
 */
extern void gba_sprite_update(sprite_struct * sp);
 ...
 * @param sp The sprite
 */
extern void gba_sprite_show(sprite_struct *sp);
 ...
 * @param sp The sprite
 */
extern void gba_sprite_hide(sprite_struct *sp);
 ...
 */
extern void gba_sprite_set_pos(sprite_struct *sp, short x, short y);
 ...
 */
extern void gba_sprite_move(sprite_struct *sp, short dx, short dy);
 ...
 * @param sp Pointer to sprite
 */
extern void gba_sprite_enable_bld(sprite_struct * sp);
 ...
 * @param sp Pointer to sprite
 */
extern void gba_sprite_disable_bld(sprite_struct * sp);
 ...
 * @param sp Pointer to sprite
 */
extern void gba_sprite_flip_h(sprite_struct * sp);
 ...
 * @param sp Pointer to sprite
 */
extern void gba_sprite_flip_v(sprite_struct * sp);
 ...
 */
extern void gba_sprite_enable_rotation(sprite_struct * sp, short rot_index);
 ...
 */
extern void gba_sprite_set_angle(sprite_struct * sp, int angle);
 ...
 */
extern void gba_sprite_rotate(sprite_struct * sp, int dangle);
 ...
 */
extern void gba_sprite_set_scale(sprite_struct * sp, fixed_p scale_h, fixed_p scale_v);
 ...
 * @param sp Pointer to sprite
 */
extern void gba_sprite_enable_double_size(sprite_struct * sp);
 ...
 * @param sp Pointer to sprite
 */
extern void gba_sprite_disable_double_size(sprite_struct * sp);
 ...
 */
extern void gba_sprite_set_frame_seq(sprite_struct * sp, const short* seq, short len);
 ...
 */
extern void gba_sprite_set_frame(sprite_struct * sp, short offset);
 ...
 * @param sp Pointer to sprite
 */
extern void gba_sprite_next_frame(sprite_struct * sp);
 ...
 */
extern void gba_sprite_set_mosaic_size(short h_size, short v_size);
 ...
 * @param sp Pointer to sprite
 */
extern void gba_sprite_enable_mosaic(sprite_struct * sp);
 ...
 * @param sp Pointer to sprite
 */
extern void gba_sprite_disable_mosaic(sprite_struct * sp);
 ...
 */
extern char gba_sprite_overlap(sprite_struct * sp1, sprite_struct * sp2);
